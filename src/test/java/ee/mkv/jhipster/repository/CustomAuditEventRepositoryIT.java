...
import ee.mkv.jhipster.config.audit.AuditEventConverter;
import ee.mkv.jhipster.domain.PersistentAuditEvent;
...
import static ee.mkv.jhipster.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
